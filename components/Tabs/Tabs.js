class TabLink {
    ...
    this.tabData = this.tabElement.dataset.tab;
      ...
      // else if `all` is false, only select the cards with
      // matching this.tabData values
      this.cards = document.querySelectorAll(`.card[data-tab='${this.tabData}']`);
		...
		this.cards = Array.from(this.cards).map((e) => {
	...
	selectTab() {
      ...
      e.classList.remove('active-tab');
		...
		// Iterate through the NodeList setting the
		//display style each one to 'none'
